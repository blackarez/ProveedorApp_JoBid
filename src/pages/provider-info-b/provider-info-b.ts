...
export class ProviderInfoBPage {
  ...
  saveInfoService(){
    let DataServiceInfo = {"prof_textPersonal":this.textPersonal,"prof_Phone":this.Phone,"prof_Mobile":this.Mobile,"prof_experiencia":this.experiencia,"prof_moreInformation":this.moreInformation};
